...
class tensor:
  ...
  def __pow__(self, pow):
    ...
    out = tensor(_pow(self.data, pow), child=(self,), requires_grad=True)
...
# from .helpers.shape import get_shape, broadcast_array, broadcasted_shape, _flatten, _squeeze, _unsqueeze, _reshape, re_transpose
# from .helpers.utils import zeros, ones
# from .helpers.acitvations import relu, sigmoid, tanh, gelu
# from .axgrad import backward
# import math
...
#   def broadcast(self, other):
#     other = other if isinstance(other, tensor) else tensor(other)
#     new_shape = broadcasted_shape(self.shape, other.shape)
